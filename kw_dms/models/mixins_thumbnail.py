...
class Thumbnail(models.AbstractModel):
    ...
    def _get_icon_disk_path(self):
        ...
        return path or get_resource_path(
            "kw_dms", folders, "file_unknown.svg")
    ...
    def _get_icon_url(self):
        ...
        return "/kw_dms/static/icons/%s" % icon_name
    ...
    def _compute_icon_url(self):
        ...
        for one in self:
            ...
            one.icon_url = (
                "/web/image/{}/{}/image_128/128x128?crop=1".format(
                    one._name, one.id)
                if one.image_128
